...
extern bool LoadM30 = true;
extern bool LoadH1  = true;
extern bool LoadH4  = true;
...
string ExpertName = "Futures_Loader";
...
//--- create timer
   ...
   FileNameM30 = FilePatch+"30m_"+Symbol()+".csv"; 
   FileNameH1 = FilePatch+"1h_"+Symbol()+".csv"; 
   FileNameH4 = FilePatch+"4h_"+Symbol()+".csv"; 
   FileNameD1 = FilePatch+"1d_"+Symbol()+".csv"; 
