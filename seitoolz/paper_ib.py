...
def exec_open_pos(pos, systemname, quant, sym, type, currency, exch, price, pricefeed, date):
        ...
        if 'symbol' in pos:
            ...
            account=update_account_pnl(systemname, 'ib',tradepl, purepl, buy_power, unr_pnl, pure_unr_pnl, date, share_pnl, real_share_pnl)
...
def exec_close_pos(pos, systemname, quant, sym, type, currency, exch, price, pricefeed, date):
        ...
        if 'symbol' in pos:
            ...
            share_pnl=float(purepl) / price
            real_share_pnl=float(tradepl) / price
