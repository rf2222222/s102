        ...
        if trade:
                ...
                if not sentEntryOrder[sym1+sym2] and not pos.has_key(bar1['Symbol']) and not pos.has_key(bar2['Symbol']):
                    ...
                    if dblZscoreData >= dblUpperThreshold and crossAbove[sym1+sym2]:
                        ...
                        return ([bar1['Symbol'], abs(dblQty), strOrderComment], 
                                [bar2['Symbol'], abs(dblQty), strOrderComment2])
                    
                elif not sentExitOrder[sym1+sym2] and (pos.has_key(bar1['Symbol']) or pos.has_key(bar2['Symbol'])):
                    
                    if pos.has_key(bar1['Symbol']) and pos.has_key(bar2['Symbol']) and \
                       pos[bar1['Symbol']] < 0 and pos[bar2['Symbol']] > 0 and \
                    ...
                    elif pos.has_key(bar1['Symbol']) and \
                        pos[bar1['Symbol']] > 0  and \
